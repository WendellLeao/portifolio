...
let data = {
    english: 
    {
        ...
        arrowDescription: "This project was a programming test. The goal was to develop a project with as much technical quality as possible to assess how much I learned during my bootcamp period. I just took care of the programming part.",
        ...
        claudioDescription: "A simple personal project I did during the college holidays to practice programming. I took care of everything except the art that was obtained from a free asset store.",
        fruitsSynopsis: "\"Face the enemies and collect all the fruits to advance to the next level in this beautiful 2D platformer.\"",
        fruitsDescription: "Another personal project that I developed to practice. My main goal with this project was to develop a simple game with fun and fluid mechanics. The art was acquired in a free assets store.",
    ...
    portuguese: 
    {
        ...
        homeSubTitle: "Game Developer",
        homeDescription: "Sou um desenvolvedor brasileiro de 21 anos. Epecialista em Unity e na linguagem C#.",
        aboutSubTitle: "Sobre mim",
        aboutDescription: "Sou desenvolvedor de jogos a mais de 2 anos. Atualmente faço parte de um time brasileiro trabalhando no jogo Rogue Masters, atuando principalmente como programador de networking.",
        ...
        claudioDescription: "Um simples projeto pessoal que fiz durante as férias da faculdade para praticar programação. Cuidei de tudo exceto da arte que foi obtida em uma loja de assets gratuitos.",
        ...
        fruitsDescription: "Mais um projeto pessoal que desenvolvi para praticar. Meu principal objetivo com este projeto foi desenvolver um jogo simples com mecânica divertida e fluida. A arte foi adquirida em uma loja de assets gratuitos.",
